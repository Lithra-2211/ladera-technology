...
const StyledContainer = styled.div<{
  ...
  /* Custom Ladera Blue Active States */
  div[aria-current="page"], a[aria-current="page"], .active {
    background: #2563eb !important;
    color: #ffffff !important;
    border-radius: 8px !important;
  }
  
  div[aria-current="page"] svg, a[aria-current="page"] svg, .active svg,
  ...
  /* Light hover */
  div:not([aria-current="page"]):hover {
