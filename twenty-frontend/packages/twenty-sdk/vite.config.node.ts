...
// `require(...)` and read `__filename` / `__dirname` at runtime â€” none of which
// exist in an ES module â€” so we recreate them from `import.meta.url`. Without
...
// (dist/), not each inlined module's original node_modules path â€” so a bundled
